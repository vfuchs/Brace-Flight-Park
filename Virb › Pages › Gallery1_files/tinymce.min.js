...
virb.$(function(){
    ...
    tinymce.init({
        ...
        menubar: false,
        plugins: 'compat3x,link,code,pagebreak,image,paste',
        external_plugins: {
            "embed": "/_assets/_js/tinymce/plugins/embed/editor_plugin.js",
            "filestorage": "/_assets/_js/tinymce/plugins/filestorage/editor_plugin.js"
        },
        toolbar: "bold italic underline removeformat bullist numlist blockquote hr alignleft aligncenter alignright alignjustify link unlink image embed code filestorage | formatselect styleselect fontsizeselect",
        paste_word_valid_elements: "b,strong,i,em,h1,h2,h3,p,ul,li,ol,table,tr,td,th",
        convert_urls: false,
        valid_elements: "*[*]",
        extended_valid_elements: "+a[*],+div[*],object[*],embed[*],param[*],+script[*],span[*],video[*],iframe[*]",
        valid_children: "+div[script],+body[style],+body[link]",
        pagebreak_separator : '<virb get="read_more" />',
        fontsize_formats : "8px 9px 10px 11px 12px 14px 16px 18px 20px 24px",
        formats : {
            alignleft : {selector : 'p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img', styles : {textAlign : 'left'}, classes : 'left'},
            aligncenter : {selector : 'p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img', styles : {textAlign : 'center'}, classes : 'center'},
            alignright : {selector : 'p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img', styles : {textAlign : 'right'}, classes : 'right'},
        ...
        target_list: [
            {title: 'Open Link in the same window', value: '_self'},
            {title: 'Open link in a new window', value: '_blank'}
        ],
